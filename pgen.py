...
def print_cow():
    ...
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Twitter: https://twitter.com/HacklikeHacker | https://techyrick.com ]"
    )
    print(28 * " " + "[ pgen | https://github.com/moulik-source/]\r\n")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
                ...
                unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in pgen.cfg too...
    ...
    print_to_file(file_to_open + ".pgen.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the pgen utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "pgen.cfg"))
...
def get_parser():
    ...
    to use"""
    parser = argparse.ArgumentParser(description="Fuck my ass& dick")
